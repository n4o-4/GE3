...
void Object3d::Draw(WorldTransform worldTransform,ViewProjection viewProjection, Lightmanager *lightManager)
{
	...
	object3dCommon->GetDxCommon()->GetCommandList()->SetGraphicsRootConstantBufferView(3, lightManager->GetCBuffer()->GetGPUVirtualAddress());
