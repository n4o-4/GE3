...
void Object3dCommon::SetView()
{
	...
	dxCommon_->commandList->SetPipelineState(graphicsPipelineState.Get());  // PSOを設定
...
void Object3dCommon::CreateRootSignature()
{
	...
	hr = dxCommon_->device->CreateRootSignature(0, signatureBlob->GetBufferPointer(), signatureBlob->GetBufferSize(), IID_PPV_ARGS(&rootSignature));
	assert(SUCCEEDED(hr));
}
...
void Object3dCommon::CreateGraphicsPipeline()
{
	...
	hr = dxCommon_->device->CreateGraphicsPipelineState(&graphicsPipelineStateDesc, IID_PPV_ARGS(&graphicsPipelineState));
	assert(SUCCEEDED(hr));
}
